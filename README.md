...
## Master thesis
Final result of my work can read in Praca_Magisterska__Optymalizacja_algorytmu_Path_Tracingu_w_grafice_komputerowej.pdf file (Available only in Polish, Sorry!)
